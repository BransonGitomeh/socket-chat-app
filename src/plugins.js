var plugins = function() {
    ...
    $("#map-world")[0] && $("#map-world").vectorMap({
            ...
            onRegionClick: function(event) { event.preventDefault() }
        })
        // });
